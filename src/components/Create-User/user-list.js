...
// Delete User
    ...
    var columns = [
        ...
        { 
            ...
            sortable: true, 
            cell: row => 
            row.account_status === "Active" ?<button className="btn btn-primary  addNewItem" onClick={()=>handleDeactiveUser(row.id)}>DeActive</button>:
            <button className="btn btn-primary  addNewItem" onClick={()=>handleActiveUser(row.id)}>Active</button>
        },
    ];
