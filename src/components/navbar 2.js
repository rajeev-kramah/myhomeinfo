...
const Navbar = (props) => {
  ...
  useEffect(() => {
    props.ownerHouseDetails({
      owner_id: JSON.parse(localStorage.getItem("user")).email,
    });
  }, []);
  ...
  const updateHouse = (id, type) => {
    ...
    var param = {
      data: [{ id: id, email: JSON.parse(localStorage.getItem("user")).email }],
    };
    props.getHouseDetail(param);
  };
      ...
      <nav className="navbar navbar-default navbar-fixed-top outer-bg">
        <div className="container-fluid">
          <div className="navbar-header">
            <NavLink
              className="navbar-brand header-color"
              to={"/dashboard"}
              onClick={() => updateHouse(props.house[0]["house"]["id"], "")}
            >
            ...
            <li className="dropdown">
              ...
              <ul className="dropdown-menu">
                <li>
                  ...
                  >
                    <span className="glyphicon glyphicon-user header-color" />{" "}
                    Account Details
                  </NavLink>
                </li>
                <li>
                  <NavLink to={"/"} onClick={handleLogout}>
                    <span className="glyphicon glyphicon-log-in header-color" />{" "}
                    Logout
                  </NavLink>
                </li>
                <li>
                    ...
                    <li
                      ...
                      className={
                        house_id === house.house.id
                          ? "dropdown houseDropDown house-selected"
                          : "dropdown houseDropDown"
                      }
                    >
                      <NavLink
                        to="/"
                        ...
                        <section className="homeDropDown">
                          <section>
                            <li>
                              <NavLink
                                onClick={() =>
                                  updateHouse(house.house.id, "contact")
                                }
                                to={{
                                  pathname: "/contact",
                            ...
                            <li>
                              <NavLink
                                ...
                                onClick={() =>
                                  updateHouse(house.house.id, "loan")
                                }
                              >
                                Loans
                              </NavLink>
                            ...
                            <li>
                              <NavLink
                                ...
                                onClick={() =>
                                  updateHouse(house.house.id, "insurance")
                                }
                              >
                                Insurance
                              </NavLink>
                            ...
                            <li>
                              <NavLink
                                ...
                                onClick={() =>
                                  updateHouse(house.house.id, "transaction")
                                }
                              >
                                Transactions
                              </NavLink>
                          ...
                          <section>
                            <li>
                              <NavLink
                                ...
                                onClick={() =>
                                  updateHouse(house.house.id, "warranty")
                                }
                              >
                                Warranties
                              </NavLink>
                            ...
                            <li>
                              <NavLink
                                ...
                                onClick={() =>
                                  updateHouse(house.house.id, "homecost")
                                }
                              >
                                Home Cost
                              </NavLink>
                            ...
                            <li>
                              <NavLink
                                ...
                                onClick={() =>
                                  updateHouse(house.house.id, "shareproperty")
                                }
                              >
                                Share Property
                              </NavLink>
                            ...
                            <li>
                              <NavLink
                                ...
                                onClick={() =>
                                  updateHouse(house.house.id, "leases")
                                }
                              >
                                Leases
                              </NavLink>
                          ...
                          <section>
                            <li>
                              <NavLink
                                ...
                                onClick={() =>
                                  updateHouse(house.house.id, "document")
                                }
                              >
                                Documents
                              </NavLink>
                            ...
                            <li>
                              <NavLink
                                ...
                                onClick={() =>
                                  updateHouse(house.house.id, "link")
                                }
                              >
                                Links
                              </NavLink>
                            ...
                            <li>
                              <NavLink
                                ...
                                onClick={() =>
                                  updateHouse(house.house.id, "gallary")
                                }
                              >
                                Gallaries
                              </NavLink>
                            ...
                            <li>
                              <NavLink
                                ...
                                onClick={() =>
                                  updateHouse(house.house.id, "reminders")
                                }
                              >
                                Reminders
                              </NavLink>
                          ...
                          <section>
                            <li>
                              <NavLink
                                ...
                                onClick={() =>
                                  updateHouse(house.house.id, "report")
                                }
                              >
                                Reports
                              </NavLink>
                            ...
                            <li>
                              <NavLink
                                ...
                                onClick={() =>
                                  updateHouse(house.house.id, "incident")
                                }
                              >
                                Incidents
                              </NavLink>
