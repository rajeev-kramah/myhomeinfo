...
const LeaseList = (props) => {
    ...
    var columns = [

        {
            ...
            selector: 'tenant_name1',
            sortable: true,
            cell: row => <Link data-tag="allowRowEvents" role="link" to={{ pathname: "tenant", state: { house_id: house_id } }}>{row.tenant_name1 && row.tenant_name1.split("-")[1]}</Link>
        },
        { name: 'Tenant Phono No.', selector: 'tenant_phone1', sortable: true, },
    ...
    return (
        <div className="container-fluid loan">
            ...
            <div className="loan-inner padding-4 mt-10">
                {leaseData !== undefined &&
