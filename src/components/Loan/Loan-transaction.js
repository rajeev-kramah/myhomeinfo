...
const LoanTransaction = (props) => {
    ...
    useEffect(()=> {
        if(props.loanDetails && props.loanDetails.length > 0) {
            ...
            setStartDate(props.loanDetails[0].renewal_maturity_date ? props.loanDetails[0].renewal_maturity_date : props.loanDetails[0].loanbegindate);
    ...
    const handleDelete = () => {
        props.deleteLoanTransaction({loan_id: props.loanDetails[0].id
        });
        setTableData([])
    }
                            ...
                            <div className="row ">
                                ...
                                <div className="col-md-4">
                                    <div className="form-group">
                                        ...
                                        <input type="text" placeholder="Start Date" value={rateofinterest} onChange={e=> setRateofinterest(e.target.value)} className="form-control" readOnly/>
                                    </div>
                                </div>
                            </div>
