                        ...
                        <div className="row pt-25">
                            <div className="col-md-6">
                                <div className="form-group inputGroup">
                                    ...
                                    <input type="date" value={payment_date} onChange={e => setPayment_date(e.target.value)} className="form-control" />
                                </div>
                            </div>
                            <div className="col-md-6 ">
                        ...
                        <div className="row pt-25">
                            <div className="col-md-6">
                                <div className="form-group">
                                    ...
                                    <select className="form-control" value={account_status} onChange={e => handleAccount_status(e)} disabled>
